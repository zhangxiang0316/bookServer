...
!function (e) {
    ...
    var E, z = {}, A = 1, M = 2, F = 3, J = 4, O = {}, P = {require: i, exports: 1, module: 1}, D = v(), N = {
        baseUrl: "./",
        paths: {},
        config: {},
        map: {},
    ...
    var a = e("./config"), o = e("zrender/tool/util"), r = e("zrender/tool/event"), s = {},
        l = e("zrender/tool/env").canvasSupported, h = new Date - 0, d = {}, c = "_echarts_instance_";
    ...
    return i.prototype = {
        _init: function () {
            ...
            var u = e("./component");
            u.define("title", e("./component/title")), u.define("tooltip", e("./component/tooltip")), u.define("legend", e("./component/legend")), (0 === i.getWidth() || 0 === i.getHeight()) && console.error("Dom鈥檚 width & height should be ready before init.")
    ...
    function e(e) {
        var t = this.os = {}, i = this.browser = {}, n = e.match(/Web[kK]it[\/]{0,1}([\d.]+)/),
            ...
            l = e.match(/(webOS|hpwOS)[\s\/]([\d.]+)/), h = l && e.match(/TouchPad/), d = e.match(/Kindle\/([\d.]+)/),
            c = e.match(/Silk\/([\d._]+)/), m = e.match(/(BlackBerry).*Version\/([\d.]+)/),
            p = e.match(/(BB10).*Version\/([\d.]+)/), u = e.match(/(RIM\sTablet\sOS)\s([\d.]+)/),
            V = e.match(/PlayBook/), U = e.match(/Chrome\/([\d.]+)/) || e.match(/CriOS\/([\d.]+)/),
            g = e.match(/Firefox\/([\d.]+)/), f = e.match(/MSIE ([\d.]+)/), y = n && e.match(/Mobile\//) && !U,
            b = e.match(/(iPhone|iPod|iPad).*AppleWebKit(?!.*Safari)/) && !U, f = e.match(/MSIE\s([\d.]+)/);
    ...
    var i = e("./tool/util"), n = e("./tool/log"), a = e("./tool/guid"), o = e("./Handler"), r = e("./Painter"),
        s = e("./Storage"), l = e("./animation/Animation"), h = {}, d = {};
    ...
    var i = e("./base"), n = e("zrender/shape/Line"), a = e("zrender/shape/Image"), o = e("zrender/shape/Rectangle"),
        r = e("../util/shape/Icon"), s = e("../config");
    s.toolbox = {
        zlevel: 0,
        z: 6,
        show: !1,
        ...
        feature: {
            mark: {
                show: !1,
                title: {mark: "杈呭姪绾垮紑鍏�", markUndo: "鍒犻櫎杈呭姪绾�", markClear: "娓呯┖杈呭姪绾�"},
                lineStyle: {width: 1, color: "#1e90ff", type: "dashed"}
            },
            dataZoom: {show: !1, title: {dataZoom: "鍖哄煙缂╂斁", dataZoomReset: "鍖哄煙缂╂斁鍚庨€€"}},
            dataView: {show: !1, title: "鏁版嵁瑙嗗浘", readOnly: !1, lang: ["鏁版嵁瑙嗗浘", "鍏抽棴", "鍒锋柊"]},
            magicType: {
                show: !1,
                title: {
                    line: "鎶樼嚎鍥惧垏鎹�",
            ...
            restore: {show: !1, title: "杩樺師"},
            saveAsImage: {show: !1, title: "淇濆瓨涓哄浘鐗�", type: "png", lang: ["鐐瑰嚮淇濆瓨"]}
        }
    };
    ...
    return t.prototype = {
        type: s.COMPONENT_TYPE_TOOLBOX, _buildShape: function () {
            ...
            var t, i, n, o, s = this.option.toolbox, l = this._iconList.length, h = this._itemGroupLocation.x,
                d = this._itemGroupLocation.y, c = s.itemSize, m = s.itemGap,
                p = s.color instanceof Array ? s.color : [s.color], u = this.getFont(s.textStyle);
            ...
            a.href = i, a.setAttribute("download", (e.name ? e.name : this.option.title && (this.option.title.text || this.option.title.subtext) ? this.option.title.text || this.option.title.subtext : "ECharts") + "." + t), a.innerHTML = '<img style="vertical-align:middle" src="' + i + '" title="' + (window.ActiveXObject || "ActiveXObject" in window ? "鍙抽敭->鍥剧墖鍙﹀瓨涓�" : e.lang ? e.lang[0] : "鐐瑰嚮淇濆瓨") + '"/>', n.appendChild(a), document.body.appendChild(n), a = null, n = null, setTimeout(function () {
    ...
    return t.prototype = {
        type: o.COMPONENT_TYPE_TITLE, _buildShape: function () {
            ...
            var e = this.titleOption.text, t = this.titleOption.link, i = this.titleOption.target,
                ...
                d = this._itemGroupLocation.x, c = this._itemGroupLocation.y, m = this._itemGroupLocation.width,
                p = this._itemGroupLocation.height, u = {
                    zlevel: this.getZlevelBase(),
                    z: this.getZBase(),
    ...
    var i = e("./base"), n = e("../util/shape/Cross"), a = e("zrender/shape/Line"), o = e("zrender/shape/Rectangle"),
        r = new o({}), s = e("../config");
    s.tooltip = {
        zlevel: 1,
        z: 8,
    ...
    var l = e("../util/ecData"), h = e("zrender/config"), d = e("zrender/tool/event"), c = e("zrender/tool/area"),
        m = e("zrender/tool/color"), p = e("zrender/tool/util"), u = e("zrender/shape/Base");
    return t.prototype = {
        ...
        _showAxisTrigger: function (e, t, i) {
            ...
            var p, u,
                V = -1 != e && this.component.xAxis.getAxis(e).type === s.COMPONENT_TYPE_AXIS_CATEGORY ? "xAxis" : -1 != t && this.component.yAxis.getAxis(t).type === s.COMPONENT_TYPE_AXIS_CATEGORY ? "yAxis" : !1;
            if (V) {
                var U = "xAxis" == V ? e : t;
        ...
        _showItemTrigger: function (e) {
            if (this._curTarget) {
                var t, i, n, a = l.get(this._curTarget, "series"), o = l.get(this._curTarget, "seriesIndex"),
                    ...
                    c = l.get(this._curTarget, "name"), m = l.get(this._curTarget, "value"),
                    p = l.get(this._curTarget, "special"), u = l.get(this._curTarget, "special2"),
                    V = [r, a, this.option], U = "";
    ...
    var i = e("./base"), n = e("zrender/shape/Text"), a = e("zrender/shape/Rectangle"), o = e("zrender/shape/Sector"),
        r = e("../util/shape/Icon"), s = e("../util/shape/Candle"), l = e("../config");
    l.legend = {
        zlevel: 0,
        z: 4,
        show: !0,
    ...
    t.prototype = {
        type: l.COMPONENT_TYPE_LEGEND, _buildShape: function () {
            ...
            var e, t, i, a, o, s, l, c, m = this.legendOption.data, p = m.length, u = this.legendOption.textStyle,
                V = this.zr.getWidth(), U = this.zr.getHeight(), g = this._itemGroupLocation.x,
                f = this._itemGroupLocation.y, y = this.legendOption.itemWidth, b = this.legendOption.itemHeight,
            ...
            var e = this.legendOption.data, t = e.length, i = this.legendOption.itemGap,
                n = this.legendOption.itemWidth + 5, a = this.legendOption.itemHeight, o = this.legendOption.textStyle,
                r = this.getFont(o), s = 0, l = 0, c = this.reformCssArray(this.legendOption.padding),
                m = this.zr.getWidth() - c[1] - c[3], p = this.zr.getHeight() - c[0] - c[2], u = 0, V = 0;
    ...
    var c = {
        line: function (e, t) {
            ...
            var i = 6, n = t.x + t.width / 2, a = t.y + t.height / 2, o = t.height / 2, r = 2 * Math.PI / i,
                s = -Math.PI / 2, l = n + o * Math.cos(s), h = a + o * Math.sin(s);
            e.moveTo(l, h), s += r;
    ...
    function z(e) {
        ...
        if (0 === o) t = 255 * r, i = 255 * r, n = 255 * r; else {
            var s = 6 * a;
            6 === s && (s = 0);
            var l = 0 | s, h = r * (1 - o), d = r * (1 - o * (s - l)), c = r * (1 - o * (1 - (s - l))), m = 0, p = 0,
                u = 0;
    ...
    function F(e) {
        var t, i, n = e[0] / 255, a = e[1] / 255, o = e[2] / 255, r = Math.min(n, a, o), s = Math.max(n, a, o),
            l = s - r, h = s;
        if (0 === l) t = 0, i = 0; else {
            i = l / s;
    ...
    var n = e("./base"), a = e("zrender/shape/Rectangle"), o = e("../util/shape/Icon"), r = e("../util/shape/Chain"),
        s = e("../config");
    s.timeline = {
        zlevel: 0,
        z: 4,
    ...
    return t.prototype = {
        type: s.COMPONENT_TYPE_TIMELINE, _buildShape: function () {
            ...
            var e, t = this.timelineOption, i = this.reformCssArray(this.timelineOption.padding),
                n = this.zr.getWidth(), a = this.parsePercent(t.x, n), o = this.parsePercent(t.x2, n);
            ...
            var t = this.timelineOption, i = null != t.data[e].name ? t.data[e].name : t.data[e],
            ...
            var t, i = this.timelineOption, n = i.symbol.toLowerCase(), a = i.symbolSize, o = i.label.rotate,
                r = i.label.textStyle, s = this.getFont(r), h = i.data, d = this._location.x,
                c = this._location.y + this._location.height / 4 * 3, m = this._location.x2 - this._location.x,
                p = h.length, u = [];
            if (p > 1) {
                var V = m / p;
            ...
            var e = this.timelineOption, t = this.reformCssArray(this.timelineOption.padding), i = this._location.width,
    ...
    return n.inherits(t, i), t.prototype._start = function (e, t) {
        var i = n.merge(this.options, {
            ...
            }), r = this.createTextShape(i.textStyle), s = this.createBackgroundShape(i.backgroundColor),
            l = i.effectOption, h = new o({highlightStyle: n.clone(l)});
    ...
    return n.inherits(t, i), t.prototype._start = function (e, t) {
        for (var i = n.merge(this.options, {
            ...
            var V = -Math.ceil(1e3 * Math.random()), U = Math.ceil(400 * Math.random()),
                g = Math.ceil(Math.random() * p), f = "random" == l.color ? a.random() : l.color;
            c[u] = new o({
    ...
    var i = e("./Base"), n = e("../tool/util"), a = e("../tool/color"), o = e("../shape/Ring"),
        r = e("../shape/Sector");
    return n.inherits(t, i), t.prototype._start = function (e, t) {
        var i = n.merge(this.options, {
            textStyle: {color: "#07a"},
    ...
    return n.inherits(t, i), t.prototype._start = function (e, t) {
        var i = n.merge(this.options, {
                ...
                backgroundColor: "rgba(0, 0, 0, 0.8)"
            }), s = this.createTextShape(i.textStyle), l = 10,
    ...
    var i = e("./Base"), n = e("../tool/util"), a = e("../tool/area"), o = e("../shape/Ring"),
        r = e("../shape/Droplet"), s = e("../shape/Circle");
    return n.inherits(t, i), t.prototype._start = function (e, t) {
        var i = n.merge(this.options, {
                textStyle: {color: "#888", textAlign: "start"},
                backgroundColor: "rgba(250, 250, 250, 0.8)"
            }), l = this.createTextShape(i.textStyle), h = 10,
        ...
        var u = this.createBackgroundShape(i.backgroundColor), V = new r({
            ...
            }), U = new s({highlightStyle: {r: Math.round(m.r / 6), brushType: "fill", color: m.colorIn}}),
            g = new o({highlightStyle: {r0: Math.round(m.r - m.r / 3), r: m.r, brushType: "fill", color: m.colorOut}}),
            f = [0, m.x, m.y];
    ...
    var e = {
        ...
        textStyle: {fontFamily: "寰蒋闆呴粦, Arial, Verdana, sans-serif"}
    };
    return e
    ...
    return document.createElement("canvas").getContext ? G_vmlCanvasManager = !1 : !function () {
        ...
        function b(e) {
            this.m_ = s(), this.mStack_ = [], this.aStack_ = [], this.currentPath_ = [], this.strokeStyle = "#000", this.fillStyle = "#000", this.lineWidth = 1, this.lineJoin = "miter", this.lineCap = "butt", this.miterLimit = 1 * F, this.globalAlpha = 1, this.font = "12px 寰蒋闆呴粦", this.textAlign = "left", this.textBaseline = "alphabetic", this.canvas = e;
        ...
        function k(e, t, i, n) {
            ...
            if (a instanceof W) {
                ...
                if ("gradient" == a.type_) {
                    var p = a.x0_ / o, u = a.y0_ / r, U = a.x1_ / o, g = a.y1_ / r, f = v(e, p, u), y = v(e, U, g),
                        b = y.x - f.x, _ = y.y - f.y;
        ...
        var C = Math, T = C.round, E = C.sin, z = C.cos, A = C.abs, M = C.sqrt, F = 10, J = F / 2,
        ...
        var H = {
                ...
                whitesmoke: "#F5F5F5",
                yellowgreen: "#9ACD32"
            }, R = {}, G = {style: "normal", variant: "normal", weight: "normal", size: 12, family: "寰蒋闆呴粦"}, Y = {},
            Z = {butt: "flat", round: "round"}, Q = b.prototype;
        Q.clearRect = function () {
            ...
            i *= F;
            var r = o ? "at" : "wa", s = e + z(n) * i - J, l = t + E(n) * i - J, h = e + z(a) * i - J,
                d = t + E(a) * i - J;
            s != h || o || (s += .125);
            ...
            var r = this.m_, s = 1e3, l = 0, h = s, d = {x: 0, y: 0}, c = [], m = g(U(this.font), this.element_),
                p = f(m), u = this.element_.currentStyle, V = this.textAlign.toLowerCase();
    ...
    var o = e("./config"), r = e("./tool/env"), s = e("./tool/event"), l = e("./tool/util"), h = e("./tool/vector"),
        d = e("./tool/matrix"), c = o.EVENT, m = e("./mixin/Eventful"),
        ...
        u = function (e) {
            ...
            resize: function (e) {
                ...
                if (u(e) || t) {
                    e = this._zrenderEventFixed(e);
                    var i = e.wheelDelta || -e.detail, n = i > 0 ? 1.1 : 1 / 1.1, a = !1, o = this._mouseX,
                        r = this._mouseY;
    ...
    var a = e("./config"), o = e("./tool/util"), r = e("./tool/log"), s = e("./loadingEffect/Base"), l = e("./Layer"),
        h = function (e, i) {
    ...
    var d = e("./Clip"), c = e("../tool/color"), m = e("../tool/util"), p = e("../tool/event").Dispatcher,
    ...
    var i = e("../tool/util"), n = e("../shape/Text"), a = e("../shape/Rectangle"), o = "Loading...",
        r = "normal 16px Arial";
    ...
    var n = e("./mixin/Transformable"), a = e("./tool/util"), o = window.G_vmlCanvasManager, r = e("./config"),
        s = function (e, a) {
    ...
    return s.prototype.initContext = function () {
        ...
        var e = this.dom, t = this.ctx, i = e.width, n = e.height, a = this.clearColor && !o, s = this.motionBlur && !o,
            l = this.lastFrameAlpha, h = r.devicePixelRatio;
    ...
    return n.prototype = {
        type: "text", brush: function (e, i) {
            ...
            if (i && (n = this.getHighlightStyle(n, this.highlightStyle || {})), "undefined" != typeof n.text && n.text !== !1) {
                ...
                var a, o = (n.text + "").split("\n"), r = t.getTextHeight("鍥�", n.textFont), s = this.getRect(n),
                    l = n.x;
        ...
        for (var g = "stroke" === i || "both" === i, _ = "fill" === i || "both" === i, x = 0; x < e.length; x++) {
            ...
            switch (k.command) {
                ...
                case"Q":
                    ...
                    break;
                case"A":
                    var L = v[0], w = v[1], W = v[2], X = v[3], I = v[4], S = v[5], K = Math.cos(I) * W + L,
                        C = Math.sin(I) * X + w;
    ...
    function k(e, t) {
        ...
        if (X[i]) return X[i];
        v = v || L.getContext(), v.save(), t && (v.font = t), e = (e + "").split("\n");
        var n = (v.measureText("鍥�").width + 2) * e.length;
        return v.restore(), X[i] = n, ++S > K && (S = 0, X = {}), n
    }

    var v, L = e("./util"), w = e("./curve"), W = {}, X = {}, I = 0, S = 0, K = 5e3, C = 2 * Math.PI, T = [-1, -1, -1],
        E = [-1, -1];
    return {
        isInside: i,
        isOutside: o,
    ...
    function t(t, n, a, o, r, s, l) {
        ...
        var h = i(n, a, o, r, s, l);
        n = (n + "").split("\n");
        var d = e("../tool/area").getTextHeight("鍥�", r);
        switch (l) {
            case"top":
                o = h.y;
                break;
    ...
    function i(t, i, n, a, o, r) {
        var s = e("../tool/area"), l = s.getTextWidth(t, a), h = s.getTextHeight("鍥�", a);
        switch (t = (t + "").split("\n"), o) {
            case"end":
            case"right":
                i -= l;
    ...
    var n = window.G_vmlCanvasManager, a = e("../tool/matrix"), o = e("../tool/guid"), r = e("../tool/util"),
        s = e("../tool/log"), l = e("../mixin/Transformable"), h = e("../mixin/Eventful"), d = function (e) {
            e = e || {}, this.id = e.id || o();
    ...
    function o(e, i, n, a, o, r) {
        var s = a + 3 * (i - n) - e, l = 3 * (n - 2 * i + e), h = 3 * (i - e), d = e - o, c = l * l - 3 * s * h,
            m = l * h - 9 * s * d, p = h * h - 3 * l * d, u = 0;
        if (t(c) && t(m)) if (t(l)) r[0] = 0; else {
            ...
            if (t(U)) {
                ...
                var v = (2 * c * l - 3 * s * m) / (2 * Math.sqrt(c * c * c)), L = Math.acos(v) / 3, w = Math.sqrt(c),
                    W = Math.cos(L), V = (-l - 2 * w * W) / (3 * s), b = (-l + w * (W + g * Math.sin(L))) / (3 * s),
    ...
    function s(e, t, i, n, a, o) {
        var r = (t - e) * a + e, s = (i - t) * a + t, l = (n - i) * a + i, h = (s - r) * a + r, d = (l - s) * a + s,
            c = (d - h) * a + h;
    ...
    return l.prototype = {
        constructor: l, updateNeedTransform: function () {
            ...
            if (this.transform) {
                var e = this.transform, t = e[0] * e[0] + e[1] * e[1], n = this.position, a = this.scale,
                    o = this.rotation;
                i(t - 1) && (t = Math.sqrt(t));
    ...
    var t = e("./tool/guid"), i = e("./tool/util"), n = e("./mixin/Transformable"), a = e("./mixin/Eventful"),
        o = function (e) {
            e = e || {}, this.id = e.id || t();
    ...
    var n = e("zrender/shape/Image"), a = e("../util/shape/Icon"), o = e("../util/shape/MarkLine"),
        r = e("../util/shape/Symbol"), s = e("zrender/shape/Polyline"), l = e("zrender/shape/ShapeBundle"),
        h = e("../config"), d = e("../util/ecData"), c = e("../util/ecAnimation"), m = e("../util/ecEffect"),
        p = e("../util/accMath"), u = e("../component/base"), V = e("../layout/EdgeBundling"),
    ...
    return i.prototype = {
        setCalculable: function (e) {
            ...
            if (this.isDrop && e.target && !t.dragIn) {
                var i, n = e.target, a = e.dragged, o = d.get(n, "seriesIndex"), r = d.get(n, "dataIndex"),
                    s = this.series, l = this.component.legend;
                if (-1 === r) {
            ...
            var o = [i, t], r = this.deepMerge(o, "itemStyle.normal.label"),
                s = this.deepMerge(o, "itemStyle.emphasis.label"), l = r.textStyle || {}, h = s.textStyle || {};
            if (r.show) {
                var d = e.style;
            ...
            var a, o, r, s, l, c, m, p = [], u = t.data, V = n.dataRange, g = n.legend, f = this.zr.getWidth(),
                y = this.zr.getHeight();
            ...
            return function (i, n) {
                ...
                for (var W = [], g = 0, X = m.length; X > g; g++) {
                    var I = m[g], S = I.rawEdge || I, f = S.rawData, x = null != f.value ? f.value : "",
            ...
            var g = this.deepQuery(u, "symbolRotate"), f = this.deepMerge(u, "itemStyle.normal"),
            ...
            null == _ && (_ = b + 2);
            var x = this.getItemStyleColor(f.color, t, o, i), k = this.getItemStyleColor(y.color, t, o, i), v = U[0],
                L = U[1], w = new a({
                    style: {
            ...
            var h = null != i[0].value ? i[0].value : "-", d = null != i[1].value ? i[1].value : "-",
            ...
            var p = [this.query(i[0], "symbolRotate") || e.symbolRotate[0], this.query(i[1], "symbolRotate") || e.symbolRotate[1]],
                u = [i[0], i[1], e], V = this.deepMerge(u, "itemStyle.normal");
            ...
            var i, n, a, o, s, l, h = this.series[e], d = this.component, c = t.data, m = d.dataRange, p = d.legend,
                u = [c[0], t];
            ...
            var e, t, i = this.option.animationThreshold / (this.canvasSupported ? 2 : 4), n = this.lastShapeList,
                a = this.shapeList, o = n.length > 0,
                r = o ? this.query(this.option, "animationDurationUpdate") : this.query(this.option, "animationDuration"),
                s = this.query(this.option, "animationEasing"), l = {}, d = {};
            ...
            if (this.selectedMap[n.name]) {
                var a = this.query(this.option, "animationDurationUpdate"),
                    o = this.query(this.option, "animationEasing"), r = n[i].data, s = this.shapeList.length;
    ...
    var i = e("zrender/shape/Base"), n = e("./Icon"), a = e("zrender/shape/Line"), o = new a({}),
        r = e("zrender/shape/BezierCurve"), s = new r({}), l = e("zrender/tool/area"),
        h = e("zrender/shape/util/dashedLineTo"), d = e("zrender/tool/util"), c = e("zrender/tool/curve");
    return t.prototype = {
        type: "mark-line", brush: function (e, t) {
            ...
            var t = e.curveness || 0, i = 1, n = e.xStart, a = e.yStart, o = e.xEnd, r = e.yEnd,
                s = (n + o) / 2 - i * (a - r) * t, l = (a + r) / 2 - i * (o - n) * t;
            e.cpX1 = s, e.cpY1 = l
            ...
            if ("none" != t.symbol[i]) {
                ...
                var o = t.xStart, r = t.yStart, s = t.xEnd, l = t.yEnd, h = 0 === i ? o : s, d = 0 === i ? r : l,
                    m = t.curveness || 0, p = null != t.symbolRotate[i] ? t.symbolRotate[i] - 0 : 0;
    ...
    var t = e("./Base"), i = e("./util/smoothSpline"), n = e("./util/smoothBezier"), a = e("./util/dashedLineTo"),
        o = function (e) {
    ...
    function t(e, t, i, n) {
        var a, r = i.effect, l = r.color || i.style.strokeColor || i.style.color, d = r.shadowColor || l,
            c = r.scaleSize, m = r.bounceDistance, p = "undefined" != typeof r.shadowBlur ? r.shadowBlur : c;
    ...
    function i(e, t, i, n) {
        var a = i.effect, o = a.color || i.style.strokeColor || i.style.color, r = a.scaleSize, s = a.shadowColor || o,
            l = "undefined" != typeof a.shadowBlur ? a.shadowBlur : 2 * r, h = window.devicePixelRatio || 1, c = new d({
                zlevel: n,
                position: i.position,
                scale: i.scale,
                style: {
    ...
    function n(e, t, i, n, a) {
        var s = i.effect, h = i.style, d = s.color || h.strokeColor || h.color, c = s.shadowColor || h.strokeColor || d,
            V = h.lineWidth * s.scaleSize, U = "undefined" != typeof s.shadowBlur ? s.shadowBlur : V,
            g = new r({zlevel: n, style: {x: U, y: U, r: V, color: d, shadowColor: c, shadowBlur: U}, hoverable: !1}),
            f = 0;
        if (u && !a) {
            var n = g.zlevel;
    ...
    var o = e("../util/ecData"), r = e("zrender/shape/Circle"), s = e("zrender/shape/Image"),
        l = e("zrender/tool/curve"), h = e("../util/shape/Icon"), d = e("../util/shape/Symbol"),
        c = e("zrender/shape/ShapeBundle"), m = e("zrender/shape/Polyline"), p = e("zrender/tool/vector"),
    ...
    var i = e("../config"), n = e("../util/ecData"), a = e("../util/ecQuery"), o = e("../util/number"),
    ...
    var r = e("../data/KDTree"), s = e("zrender/tool/vector"), l = s.create, h = s.distSquare, d = s.dist, c = s.copy,
        m = s.clone;
    ...
    return i.prototype = {
        type: "bezier-curve", buildPath: function (e, t) {
            ...
            if (e.__rect) return e.__rect;
            var t = Math.min(e.xStart, e.xEnd, e.cpX1), i = Math.min(e.yStart, e.yEnd, e.cpY1),
                n = Math.max(e.xStart, e.xEnd, e.cpX1), a = Math.max(e.yStart, e.yEnd, e.cpY1), o = e.cpX2, r = e.cpY2;
    ...
    var t = e("../tool/math"), i = e("../tool/computeBoundingBox"), n = e("../tool/vector"), a = e("./Base"),
        o = n.create(), r = n.create(), s = n.create(), l = n.create(), h = function (e) {
            a.call(this, e)
        };
    return h.prototype = {
        type: "sector", buildPath: function (e, i) {
            ...
            if (e.__rect) return e.__rect;
            var a = e.x, h = e.y, d = e.r0 || 0, c = e.r, m = t.degreeToRadian(e.startAngle),
                p = t.degreeToRadian(e.endAngle), u = e.clockWise;
    ...
    function i(e, t, i, n, a, r) {
        ...
        var d = Math.min.apply(null, s), c = Math.max.apply(null, s), m = Math.min.apply(null, h),
    ...
    function n(e, t, i, n, a) {
        ...
        var l = 1 - r, h = 1 - s, d = l * l * e[0] + 2 * l * r * t[0] + r * r * i[0],
            c = l * l * e[1] + 2 * l * r * t[1] + r * r * i[1], m = h * h * e[0] + 2 * h * s * t[0] + s * s * i[0],
    ...
    var a = e("./vector"), o = e("./curve"), r = a.create(), s = a.create(), l = a.create(),
    ...
    var i = e("zrender/shape/Base"), n = e("./Icon"), a = e("zrender/shape/util/dashedLineTo"),
        o = e("zrender/tool/util"), r = e("zrender/tool/matrix");
    return t.prototype = {
    ...
    var i = e("./base"), n = e("zrender/shape/Line"), a = e("../config"), o = e("../util/ecData"),
        r = e("zrender/tool/util"), s = e("zrender/tool/color");
    return t.prototype = {
        type: a.COMPONENT_TYPE_AXIS, axisBase: {
            _buildAxisLine: function () {
                var e = this.option.axisLine.lineStyle.width, t = e / 2,
                    i = {_axisShape: "axisLine", zlevel: this.getZlevelBase(), z: this.getZBase() + 3, hoverable: !1},
                    a = this.grid;
    ...
    var i = e("./base"), n = e("zrender/shape/Rectangle"), a = e("zrender/shape/Polygon"), o = e("../util/shape/Icon"),
        r = e("../config");
    r.dataZoom = {
        zlevel: 0,
        z: 4,
    ...
    return t.prototype = {
        type: r.COMPONENT_TYPE_DATAZOOM, _buildShape: function () {
            ...
            var o = new n(this.ecTheme, null, !1, {xAxis: a, series: this.option.series}, this, "xAxis"),
            ...
            for (var e = ["xAxis", "yAxis"], t = 0, i = e.length; i > t; t++) {
                ...
                for (var a in n) {
                    var o = n[a];
                    if (null != o) {
                        var r = o.length, l = Math.floor(this._zoom.start / 100 * r),
            ...
            var d = this._zoom.seriesIndex[0], c = this.option.series[d][e + "Index"] || 0, m = this.option[e][c].type,
                p = this._zoom.scatterMap[d][e.charAt(0)].min, u = this._zoom.scatterMap[d][e.charAt(0)].max, V = u - p;
            ...
            var n, a = (i.x - t.x) / t.width, o = 1 - (i.x + i.width - t.x) / t.width,
                r = 1 - (i.y + i.height - t.y) / t.height, s = (i.y - t.y) / t.height;
    ...
    var i = e("./base"), n = e("zrender/shape/Text"), a = e("zrender/shape/Line"), o = e("zrender/shape/Rectangle"),
        r = e("../config");
    r.categoryAxis = {
        zlevel: 0,
        z: 0,
    ...
    return t.prototype = {
        type: r.COMPONENT_TYPE_AXIS_CATEGORY, _getReformedLabel: function (e) {
                    ...
                    for (d = 1 > d ? 1 : d, e = Math.floor(15 / r); !h && n > e;) {
                        ...
                        for (var c = Math.floor((n - 1) / e) * e; c >= 0; c -= e) {
                            if (0 !== this.option.axisLabel.rotate) o = t; else if (i[c].textStyle) o = l.getTextWidth(this._getReformedLabel(c), this.getFont(s.merge(i[c].textStyle, this.option.axisLabel.textStyle))); else {
                                var m = this._getReformedLabel(c) + "", p = (m.match(/\w/g) || "").length,
                                    u = m.length - p;
                                o = p * t * 2 / 3 + u * t
                            }
                            if (o > a) {
            ...
            var e, t = this.option.data, i = this.option.data.length, n = this.option.axisTick, o = n.length,
                r = n.lineStyle.color, s = n.lineStyle.width,
                ...
                h = l ? 1 : "auto" == n.interval ? this._interval : n.interval - 0 + 1, d = n.onGap,
            ...
            var e, t, i = this.option.data, a = this.option.data.length, o = this.option.axisLabel, r = o.rotate,
                l = o.margin, h = o.clickable, d = o.textStyle, c = "function" == typeof o.interval ? o.interval : !1;
            ...
            var e, t = this.option.data, i = this.option.data.length, n = this.option.splitLine, o = n.lineStyle.type,
                r = n.lineStyle.width, s = n.lineStyle.color;
            ...
            if (n instanceof Array) {
                var a = n.length, r = this.option.data.length,
    ...
    return t.prototype = {
        type: r.COMPONENT_TYPE_AXIS_VALUE, _buildShape: function () {
            ...
            var e, t = this._valueList, i = this._valueList.length, n = this.option.axisTick, o = n.length,
                r = n.lineStyle.color, s = n.lineStyle.width;
            ...
            var e, t = this._valueList, i = this._valueList.length, a = this.option.axisLabel.rotate,
                o = this.option.axisLabel.margin, r = this.option.axisLabel.clickable,
            ...
            var e, t = this._valueList, i = this._valueList.length, n = this.option.splitLine, o = n.lineStyle.type,
                r = n.lineStyle.width, s = n.lineStyle.color;
            s = s instanceof Array ? s : [s];
            var l = s.length;
            ...
            var e = null != this.option.splitNumber ? this.option.splitNumber : 5,
                t = s.getAutoFormatter(this._min, this._max, e), i = t.formatter, n = t.gapValue;
            ...
            var t = e("../util/accMath"), i = null != this.option.splitNumber ? this.option.splitNumber : 5,
    ...
    function i(e, i) {
        ...
        var n = h(i), a = n.getFullYear(), o = n.getMonth() + 1, r = n.getDate(), s = n.getHours(), l = n.getMinutes(),
            d = n.getSeconds();
    ...
    function f(e, t, i) {
        ...
        var l, h, d, c = [[5, 10], [10, 2], [50, 10], [100, 2]], m = [], p = [], u = o(t - e, 3), V = o(e, -1, 1),
            U = o(t, -1);
    ...
    var m, p, u, V, U, g, f, y, b, _, x = e("./number"), k = Math, v = k.log, L = k.pow, w = k.abs, W = k.ceil,
        X = k.floor, I = k.E, S = k.LN10, K = k.LN2, C = K / S, T = 1e-9, E = 5, z = 2,
        A = {0: "鈦�", 1: "鹿", 2: "虏", 3: "鲁", 4: "鈦�", 5: "鈦�", 6: "鈦�", 7: "鈦�", 8: "鈦�", 9: "鈦�", "-": "鈦�"};
    return t
});